 ...
 */
__kernel void lbm_kernel_alpha_boundary(
		...
		)
{
	...
	pos.w = 0;
	// if this is not a boundary cell stop the execution
	if( !(pos.x == 1 || pos.x == DOMAIN_CELLS_X-2 || pos.y == 1 || pos.y == DOMAIN_CELLS_Y-2 || pos.z == 1 ||  pos.z == DOMAIN_CELLS_Z-2) )
		return;
