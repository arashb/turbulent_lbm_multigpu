...
| version | description                                                              |
|---------+--------------------------------------------------------------------------|
| v1.0    | - support of multi-gpu (no overlapping of communicaiton and computation) |
|         | - support of arbitrary number of subdomains in each dimension            |
|---------+--------------------------------------------------------------------------|
| v1.1    | - automatic benchmarking of code                                         |
|---------+--------------------------------------------------------------------------|
